...
enum UploadType { case primary, reference }
...
struct ModifyObjectView: View {
            ...
            ProcessingView(
                ...
                onAppear: {
                    Task {
                        ...
                        viewModel.currentSource = "ModifyObjectView"
                        viewModel.currentPrompt = prompt

                        // Build prompt (requires you to add this helper)
                        let finalPrompt = PromptBuilder.buildModifyObjectPrompt(
                            userPrompt: prompt,
    ...
    private func mainBrushInterface() -> some View {
        VStack(spacing: ScaleUtility.scaledSpacing(20)) {
            ...
            PromptView(screen: "ModifyObject", prompt: $prompt, isInputFocused: $searchFocused)
        }
    }
