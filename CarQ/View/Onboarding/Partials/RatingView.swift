            ...
            ZStack {
                HStack(spacing: 0) {
                    ...
                    Image(.hezagonalIcon1)
                        .resizable()
                        .frame(width: ScaleUtility.scaledValue(48), height: ScaleUtility.scaledValue(196))
                ...
                .offset(y: ScaleUtility.scaledSpacing(-5))
                
                VStack(spacing: ScaleUtility.scaledSpacing(51)) {
