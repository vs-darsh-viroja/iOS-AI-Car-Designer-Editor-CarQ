...
class UserSettings: ObservableObject {
    ...
    private struct Keys {
        ...
        static let freeImageGenerated = "free_image_converted"
        static let rewardAdsImageGenerated = "reward_ads_image_converted"
    }
    ...
    @Published var freeImageGenerated: Int {
        didSet {
            defaults.set(freeImageGenerated, forKey: Keys.freeImageGenerated)
        }
    }
    @Published var rewardAdsImageGenerated: Int {
        didSet {
            defaults.set(rewardAdsImageGenerated, forKey: Keys.rewardAdsImageGenerated)
        }
    }
    ...
    init() {
        ...
        self.freeImageGenerated = defaults.integer(forKey: Keys.freeImageGenerated)
        self.rewardAdsImageGenerated = defaults.integer(forKey: Keys.rewardAdsImageGenerated)
